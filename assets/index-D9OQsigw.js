(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})(),window.BudgeeData={features:[{icon:`wallet`,title:`Счета`,text:`Карты, наличные и кошельки в одной аккуратной картине.`,tone:`mint`},{icon:`arrows`,title:`Доходы и расходы`,text:`Записывайте операции быстро и понимайте, куда уходят деньги.`,tone:`blue`},{icon:`transfer`,title:`Переводы`,text:`Перемещайте деньги между счетами без двойного учёта.`,tone:`lilac`},{icon:`calendar`,title:`Планы`,text:`Задайте ритм месяца и заранее увидьте обязательные траты.`,tone:`peach`},{icon:`target`,title:`Накопления`,text:`Двигайтесь к целям маленькими, но заметными шагами.`,tone:`mint`},{icon:`shield`,title:`Подушка`,text:`Следите, на сколько месяцев спокойствия уже накоплено.`,tone:`blue`},{icon:`hand`,title:`Долги`,text:`Помните, кому вы должны и кто должен вам.`,tone:`lilac`},{icon:`credit`,title:`Кредиты`,text:`Держите платежи, остаток и ближайшие даты перед глазами.`,tone:`peach`},{icon:`chart`,title:`Инвестиции`,text:`Учитывайте активы как часть общей финансовой картины.`,tone:`mint`},{icon:`analytics`,title:`Аналитика`,text:`Находите закономерности без сложных таблиц и формул.`,tone:`blue`}],screens:[{id:`summary`,title:`Сводка`,subtitle:`Всё важное на сегодня`,balance:`284 350 ₽`,accent:`mint`,type:`summary`,image:`/images/budgee/summary.png`},{id:`transactions`,title:`Операции`,subtitle:`История без путаницы`,balance:`– 4 870 ₽`,accent:`blue`,type:`list`,image:`/images/budgee/operations.png`},{id:`plans`,title:`Планы`,subtitle:`Июнь под контролем`,balance:`63%`,accent:`peach`,type:`plans`,image:`/images/budgee/plans.png`},{id:`analytics`,title:`Аналитика`,subtitle:`Расходы за месяц`,balance:`89 420 ₽`,accent:`lilac`,type:`analytics`,image:`/images/budgee/analytics.png`},{id:`savings`,title:`Накопления`,subtitle:`На важные мечты`,balance:`420 000 ₽`,accent:`mint`,type:`savings`,image:`/images/budgee/savings.png`},{id:`debts`,title:`Долги`,subtitle:`Всё, что нужно вернуть`,balance:`32 000 ₽`,accent:`blue`,type:`debts`,image:`/images/budgee/debts.png`},{id:`credits`,title:`Кредиты`,subtitle:`Следующий платёж`,balance:`18 900 ₽`,accent:`peach`,type:`credit`,image:`/images/budgee/credits.png`},{id:`investments`,title:`Инвестиции`,subtitle:`Часть общего капитала`,balance:`612 480 ₽`,accent:`lilac`,type:`invest`,image:`/images/budgee/investments.png`},{id:`appearance`,title:`Оформление`,subtitle:`Баджи под ваш характер`,balance:`Мята`,accent:`mint`,type:`theme`,image:`/images/budgee/appearance.png`},{id:`menu`,title:`Меню`,subtitle:`Все разделы рядом`,balance:`11 разделов`,accent:`blue`,type:`menu`,image:`/images/budgee/menu.png`},{id:`categories`,title:`Категории`,subtitle:`Порядок по-своему`,balance:`24 категории`,accent:`peach`,type:`categories`,image:`/images/budgee/categories.png`}],faq:[{question:`Когда Баджи появится в App Store?`,answer:`Приложение находится в разработке. Оставьте email в листе ожидания, и мы сообщим о тестировании и запуске.`},{question:`Нужно ли разбираться в финансах?`,answer:`Нет. Баджи проектируется для обычной жизни: понятные слова, спокойные подсказки и только нужные цифры.`},{question:`Баджи будет ругать меня за траты?`,answer:`Нет. Приложение помогает увидеть картину и принять собственное решение, а не оценивает покупки и привычки.`},{question:`Можно учитывать долги, кредиты и инвестиции?`,answer:`Да. Они встроены в общую картину финансов вместе со счетами, планами, накоплениями и подушкой.`},{question:`Как устроены хранение и синхронизация?`,answer:`Баджи проектируется как local-first приложение: основные данные доступны на устройстве, а синхронизация помогает переносить и восстанавливать их.`},{question:`Будет ли версия для Android?`,answer:`Сначала мы сосредоточены на качественной версии для iPhone. Новости о других платформах появятся позже.`}]},(function(){let e=window.BudgeeData,t={wallet:`<path d="M4 7.5h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a3 3 0 0 1-3-3v-11a3 3 0 0 1 3-3h12v5"/><path d="M15 12h5v4h-5a2 2 0 0 1 0-4Z"/>`,arrows:`<path d="m7 7 3-3 3 3"/><path d="M10 4v12"/><path d="m17 17-3 3-3-3"/><path d="M14 20V8"/>`,transfer:`<path d="M5 7h14"/><path d="m16 4 3 3-3 3"/><path d="M19 17H5"/><path d="m8 20-3-3 3-3"/>`,calendar:`<rect x="3" y="5" width="18" height="16" rx="3"/><path d="M8 3v4M16 3v4M3 10h18"/><path d="M8 14h.01M12 14h.01M16 14h.01M8 17h.01M12 17h.01"/>`,target:`<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="1"/><path d="m15.5 8.5 4-4"/>`,shield:`<path d="M12 3 4.5 6v5.3c0 4.7 3 8.1 7.5 9.7 4.5-1.6 7.5-5 7.5-9.7V6L12 3Z"/><path d="m8.5 12 2.2 2.2 4.8-5"/>`,hand:`<path d="M7 11V7a1.5 1.5 0 0 1 3 0v3-5a1.5 1.5 0 0 1 3 0v5-4a1.5 1.5 0 0 1 3 0v5-2a1.5 1.5 0 0 1 3 0v5c0 4.4-3 7-7.2 7H11c-2.1 0-3.4-.9-4.5-2.5L3 13.8a1.7 1.7 0 0 1 2.6-2.1L8 14"/>`,credit:`<rect x="2.5" y="5" width="19" height="14" rx="3"/><path d="M2.5 10h19M6 15h4"/>`,chart:`<path d="M4 20V10M10 20V4M16 20v-7M22 20H2"/><path d="m4 7 6-4 6 6 5-5"/>`,analytics:`<path d="M4 19V9M10 19V5M16 19v-7M22 19H2"/><path d="m4 8 6-4 6 5 5-5"/>`,spark:`<path d="m12 3 1.3 4.1L17 9l-3.7 1.9L12 15l-1.3-4.1L7 9l3.7-1.9L12 3Z"/><path d="m18.5 14 .7 2.2 2.3.8-2.3.8-.7 2.2-.7-2.2-2.3-.8 2.3-.8.7-2.2ZM5 14l.7 2.1L8 17l-2.3.9L5 20l-.7-2.1L2 17l2.3-.9L5 14Z"/>`,eye:`<path d="M2 12s3.7-6 10-6 10 6 10 6-3.7 6-10 6S2 12 2 12Z"/><circle cx="12" cy="12" r="2.5"/>`,heart:`<path d="M20.8 5.7a5.5 5.5 0 0 0-7.8 0L12 6.8l-1.1-1.1a5.5 5.5 0 0 0-7.8 7.8l1.1 1.1L12 22l7.8-7.4 1.1-1.1a5.5 5.5 0 0 0-.1-7.8Z"/>`,lock:`<rect x="4" y="10" width="16" height="11" rx="3"/><path d="M8 10V7a4 4 0 0 1 8 0v3M12 14v3"/>`,cloud:`<path d="M17.5 19H6a4 4 0 0 1-.5-8 6.5 6.5 0 0 1 12.4-1.4A4.8 4.8 0 0 1 17.5 19Z"/><path d="m9 15 3 3 3-3M12 18v-7"/>`,check:`<path d="m5 12 4 4L19 6"/>`,menu:`<path d="M4 7h16M4 12h16M4 17h16"/>`,close:`<path d="m6 6 12 12M18 6 6 18"/>`,arrow:`<path d="M5 12h14M14 7l5 5-5 5"/>`,chevron:`<path d="m6 9 6 6 6-6"/>`,apple:`<path d="M16.7 12.4c0-2.4 2-3.6 2.1-3.7a4.6 4.6 0 0 0-3.6-1.9c-1.5-.2-3 .9-3.8.9-.8 0-2-.9-3.3-.9a4.9 4.9 0 0 0-4.1 2.5c-1.8 3-.5 7.5 1.2 9.9.9 1.2 1.9 2.6 3.2 2.5 1.3-.1 1.8-.8 3.4-.8 1.6 0 2 .8 3.4.8 1.4 0 2.3-1.2 3.1-2.5a10.6 10.6 0 0 0 1.4-2.9 4.3 4.3 0 0 1-3-3.9ZM14.2 5.2a4.3 4.3 0 0 0 1-3.1 4.4 4.4 0 0 0-2.9 1.5 4.1 4.1 0 0 0-1.1 3c1.1.1 2.2-.5 3-1.4Z"/>`};function n(e,n=``){return`<svg class="icon ${n}" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">${t[e]||t.spark}</svg>`}function r(){return`
      <a class="brand" href="#top" aria-label="Баджи, на главную">
        <span class="brand-mark"><img src="/images/budgee/icon.png" alt="" /></span>
      ...
      <header class="site-header" id="top">
        <div class="container header-inner">
          ...
          <button class="menu-button" type="button" aria-label="Открыть меню" aria-expanded="false">
            ${n(`menu`,`menu-open-icon`)}${n(`close`,`menu-close-icon`)}
          </button>
        </div>
    ...
    `}function o(){let t=e.screens[0];return`
      <main id="main">
        <section class="hero section">
          ...
          <div class="container hero-grid">
            <div class="hero-copy reveal">
              <div class="eyebrow">${n(`apple`)}Для iPhone · скоро</div>
              ...
              <div class="hero-actions">
                <a class="button button-primary" href="#waitlist">Присоединиться к ожиданию ${n(`arrow`)}</a>
            ...
            <div class="hero-visual reveal reveal-delay">
              ...
              <div class="mascot-card">
                <img src="/images/budgee/icon.png" alt="Иконка приложения Баджи с волнистым попугайчиком" />
                <span><i></i>Баджи рядом</span>
              </div>
              <div class="floating-chip chip-plan"><i>${n(`calendar`)}</i><span><small>Планы</small><b>Месяц под контролем</b></span></div>
              <div class="floating-chip chip-savings"><i>${n(`target`)}</i><span><small>Накопления</small><b>Видимый прогресс</b></span></div>
              <div class="floating-chip chip-invest"><i>${n(`chart`)}</i><span><small>Инвестиции</small><b>В общей картине</b></span></div>
              <div class="floating-chip chip-debt"><i>${n(`hand`)}</i><span><small>Долги</small><b>Без путаницы</b></span></div>
              ${i(t,`phone-hero`)}
            </div>
          </div>
          <div class="container trust-row">
            ...
            <div>
              <b>${n(`check`)} Без осуждения</b>
              <b>${n(`check`)} Понятным языком</b>
              <b>${n(`check`)} Для реальной жизни</b>
            </div>
          </div>
        </section>
    `}function s(){return`
        ...
        <div class="container">
          ...
          <div class="problem-grid">
            ...
            <article class="problem-card reveal reveal-delay-2">
              ...
              <div class="problem-visual visual-guilt"><div>${n(`heart`)}</div><span>Вы не «плохой»<br />из-за покупки</span></div>
              <h3>Учёт давит</h3>
      ...
      <section class="section solution-section">
        <div class="container solution-grid">
          <div class="solution-copy reveal">
            ...
            <ul class="check-list">
              <li>${n(`check`)} Показывает общую картину</li>
              <li>${n(`check`)} Помогает планировать в своём темпе</li>
              <li>${n(`check`)} Объясняет цифры человеческим языком</li>
            </ul>
          </div>
          <div class="solution-bento reveal reveal-delay">
            ...
            <article class="bento-card bento-tip">${n(`spark`)}<span><b>Небольшой шаг</b><small>Отложите 3 000 ₽ после зарплаты</small></span></article>
            <article class="bento-card bento-bird">${n(`heart`)}<p>Не идеальный бюджет.<br /><b>Ваш бюджет.</b></p></article>
          </div>
        </div>
      </section>
    `}function l(){return`
          ...
          <div class="features-grid">
            ${e.features.map((e,t)=>`
                  <article class="feature-card tone-${e.tone} reveal" style="--delay:${t%5*60}ms">
                    ...
                    <div class="feature-icon">${n(e.icon)}</div>
                    <h3>${e.title}</h3>
                    <p>${e.text}</p>
                    <span class="feature-arrow">${n(`arrow`)}</span>
                  </article>
                `).join(``)}
          </div>
        </div>
      ...
      <section class="section screens-section" id="screens">
        ...
        <div class="screens-track-wrap">
          <div class="screens-track">
            ${e.screens.map(e=>i(e,`phone-gallery`)).join(``)}
          </div>
        </div>
        <div class="container screen-caption">
          <span><b>11 реальных экранов</b> · потяните в сторону, чтобы посмотреть</span>
          <button class="screens-next" type="button" aria-label="Показать следующие экраны">${n(`arrow`)}</button>
        </div>
      </section>
    `}function d(){return`
        ...
        <div class="container">
          ...
          <div class="life-timeline">
            <article class="life-card reveal">
              ...
              <div class="life-icon tone-mint">${n(`calendar`)}</div>
            ...
            <article class="life-card reveal reveal-delay">
              ...
              <div class="life-icon tone-blue">${n(`eye`)}</div>
            ...
            <article class="life-card reveal reveal-delay-2">
              ...
              <div class="life-icon tone-lilac">${n(`target`)}</div>
        ...
        <div class="container literacy-grid">
          <div class="literacy-visual reveal">
            ...
            <div class="lesson-card lesson-front">
              ...
              <button>Читать ${n(`arrow`)}</button>
            </div>
            <div class="bird-peek"><img src="/images/budgee/icon.png" alt="" /></div>
          </div>
          <div class="literacy-copy reveal reveal-delay">
            ...
            <div class="literacy-points">
              <span>${n(`spark`)} <b>По делу</b><small>Только применимые знания</small></span>
              <span>${n(`heart`)} <b>Без давления</b><small>Ваш темп и ваши решения</small></span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="customization-card">
            ...
            <div class="custom-phones reveal reveal-delay">
              ${i(e.screens[8],`phone-custom phone-custom-back`)}
              ${i(e.screens[10],`phone-custom phone-custom-front`)}
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="security-card">
            <div class="security-copy reveal">
              ...
              <div class="security-note">${n(`shield`)}<span><b>Честный подход</b><small>Мы не обещаем невозможного и продолжаем продумывать защиту на каждом этапе разработки.</small></span></div>
            </div>
            <div class="security-visual reveal reveal-delay">
              ...
              <div class="device-node">${n(`apple`)}<span>Ваш iPhone</span><b>Основные данные</b></div>
              <div class="sync-node">${n(`cloud`)}<span>Синхронизация</span></div>
              <div class="security-badge badge-lock">${n(`lock`)}<span>Доступ<br />на устройстве</span></div>
              <div class="security-badge badge-restore">${n(`transfer`)}<span>Перенос и<br />восстановление</span></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="section faq-section" id="faq">
        <div class="container faq-grid">
          <div class="faq-intro reveal">
            ...
            <div class="faq-bird">${n(`spark`)}<span>Есть вопрос?</span></div>
          </div>
          <div class="faq-list reveal reveal-delay">
            ${e.faq.map((e,t)=>`
                  <details class="faq-item" ${t===0?`open`:``}>
                    <summary><span>${String(t+1).padStart(2,`0`)}. ${e.question}</span><i>${n(`chevron`)}</i></summary>
                    <p>${e.answer}</p>
                  </details>
                `).join(``)}
          </div>
      ...
      <section class="section final-section" id="waitlist">
        <div class="container">
          <div class="final-card">
            ...
            <img class="final-bird" src="/images/budgee/icon.png" alt="Иконка приложения Баджи" />
            <div class="final-copy reveal">
              ...
              <form class="waitlist-form" novalidate>
                ...
                <button class="button button-dark" type="submit">Присоединиться ${n(`arrow`)}</button>
              </form>
    ...
    `}function _(){return`
      <footer class="site-footer">
        <div class="container footer-inner">
          <div>${r()}<p>Финансы целиком.<br />Спокойно и понятно.</p></div>
